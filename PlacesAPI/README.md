...
получение локаций с координатами и названиями - https://docs.graphhopper.com/openapi#operation/getGeocode
получение погоды по координатам - https://openweathermap.org/current 
получение списка интересных мест по координатам - https://ru.wikipedia.org/w/api.php
получение описания места по его id - https://ru.wikipedia.org/w/api.php
